        ...
        <div className={styles.successBanner}>
          <form className={styles.payForm} onSubmit={(e) => handlePayment(e)}>
            ...
            {linkDetails.description && (
              <p>
                This link was created by{" "}
                {userData?.companyName ? userData?.companyName : userData?.name}{" "}
                to fund {linkDetails.description}{" "}
                {linkDetails?.linkExpiry && (
                  <span>
                    and it expires on {formatDate(linkDetails.linkExpiry)}
                  </span>
                )}
              </p>
            )}
